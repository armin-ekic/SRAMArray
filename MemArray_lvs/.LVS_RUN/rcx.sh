#!/bin/ksh
# This script was generated Mon Apr 26 15:13:01 2021 by:
#
# Program: /mnt/software/cadence/installs/EXT182/tools.lnx86/extraction/bin/64bit//RCXspice
# Version: 15.2.0
# Created: Fri May 15 16:43:23 EST 2015
#
#/mnt/software/cadence/installs/EXT182/tools.lnx86/extraction/bin/64bit//RCXspice \
#	-techdir \
#	/mnt/software/cadence/installs/GPDK045/gpdk045_v_5_0/qrc/typical \
#	-newlvs /mnt/home/AD/armin.ekic/virtuoso/MemArray_lvs/LVS_RUN.xcn \
#	-assura_run_dir /mnt/home/AD/armin.ekic/virtuoso/MemArray_lvs \
#	-assura_run_name LVS_RUN -rcxdir \
#	/mnt/home/AD/armin.ekic/virtuoso/MemArray_lvs/LVS_RUN -xy_coordinates \
#	c,r -type full -temperature 25.0 -tempdir \
#	/mnt/home/AD/armin.ekic/virtuoso/MemArray_lvs/LVS_RUN/rcx_temp \
...
#	/mnt/home/AD/armin.ekic/virtuoso/MemArray_lvs/LVS_RUN/extview.tmp \
...
##NETS_FILE=/dev/null
##OUTPUT=/mnt/home/AD/armin.ekic/virtuoso/MemArray_lvs/LVS_RUN/extview.tmp
...
##RC_FREQUENCY=
##RCXDIR=/mnt/home/AD/armin.ekic/virtuoso/MemArray_lvs/LVS_RUN
##RCXFS_HIGH=N
...
##TEMPDIR=/mnt/home/AD/armin.ekic/virtuoso/MemArray_lvs/LVS_RUN/rcx_temp
##TEMPERATURE=25.0
##TYPE=full
...
TEMPDIR=`setTempDir /mnt/home/AD/armin.ekic/virtuoso/MemArray_lvs/LVS_RUN/rcx_temp`
export TEMPDIR
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
OUTPUT_HIERARCHY_DELIMITER='/'
cd /mnt/home/AD/armin.ekic/virtuoso/MemArray_lvs/LVS_RUN
...
/mnt/home/AD/armin.ekic/virtuoso/MemArray_lvs/LVS_RUN.xcn
ENDCAT
...
GOALIE2DIR=/mnt/software/cadence/installs/EXT182/tools.lnx86/extraction/bin
export GOALIE2DIR
vdbToRcx /mnt/home/AD/armin.ekic/virtuoso/MemArray_lvs LVS_RUN -unit meters \
	-mFactorR -- -V1 -H satfile -r \
	/mnt/home/AD/armin.ekic/virtuoso/MemArray_lvs/LVS_RUN.xcn -df2 -xgl
GOALIE2DIR=/mnt/software/cadence/installs/EXT182/tools.lnx86/extraction/bin/64bit/
export GOALIE2DIR
...
mergevia -V -tech \
	/mnt/software/cadence/installs/GPDK045/gpdk045_v_5_0/qrc/typical -cnt \
...
rex -V -m -pd -I'#' -tech \
	/mnt/software/cadence/installs/GPDK045/gpdk045_v_5_0/qrc/typical -map \
...
stamp -V -B -i np_rmetal1_conn np_rcont_poly
...
pax16 -V -lee_off -gnd ${CAP_GROUND} -ignore_cf_table -scf sip.cmd -cgnd \
	...
	/mnt/software/cadence/installs/GPDK045/gpdk045_v_5_0/qrc/typical/qrcTechFile \
...
xreduce -V -mergecap -n NET -tech \
	/mnt/software/cadence/installs/GPDK045/gpdk045_v_5_0/qrc/typical -d1 \
	-e \
	...
	L2T0 _nmos1v_MOS_2.transr _pmos1v_MOS_10.transr
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0,L2T0 -cgnd ${CAP_GROUND},1.0 -sc \
	...
	-rP res.mod np_rmetal1_conn.res,Rnp_rmetal1_conn.dev2 \
